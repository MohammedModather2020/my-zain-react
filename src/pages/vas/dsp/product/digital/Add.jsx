...
export default function VasDspAddDigitalProduct() {
  ...
  return (
    <Fragment>
      ...
      <Breadcrumb
        title='Add VAS digital product'
        textActive='Add'
        items={[
          { name: 'VAS Digital Products', url: '/vas-dsp/products/digital' },
        ]}
      />
